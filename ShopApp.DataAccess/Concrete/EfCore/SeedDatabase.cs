...
namespace ShopApp.DataAccess.Concrete.EfCore
{
    public static class SeedDatabase
    {
        public static void Seed()
        {
            ...
            if (context.Database.GetPendingMigrations().Count() == 0)//Any waiting migrations?
            {
                if (context.Categories.Count() == 0)//Ant category data?
                {
                    context.Categories.AddRange(Categories);
                }

                if (context.Products.Count() == 0)//Ant Products data?
                {
        ...
        private static Product[] Products =
        {
            ...
            new Product(){ Name="Samsung S9", Price=6000, ImageUrl="2.jpg", Description="<p>güzel telefon</p>"},
            new Product(){ Name="IPhone 6", Price=4000, ImageUrl="1.jpg", Description="<p>güzel telefon</p>"},
            new Product(){ Name="IPhone 7", Price=5000, ImageUrl="3.jpg", Description="<p>güzel telefon</p>"}
        };
